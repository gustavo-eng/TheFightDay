                ...
                paymentsUser.map(pays => (
                    <div className="mainPayment">
                        <div key={pays._id} className="containerPayment">
                            ...
                            <img src={`data:image/jpeg;base64,${pays.comprovante}`} alt="NAO DEU"/>
                            <p>Base64 image = {pays.comprovante}</p>
                            <img src={"data:image/jpeg;base64,YmxvYjpodHRwczovL3dlYi53aGF0c2FwcC5jb20vNTA4MTA4MzQtM2Q0Yy00MDY5LTk4NjgtNDA0MDM0ZjkzNjA4"} alt="n deu"/>
