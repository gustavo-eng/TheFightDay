...
import servicePayment from "../service/ServicePayment";
...
const Home = () => {
    ...
    const handlePayment = async (idCompetition) => {
        ...
        const response = await servicePayment.savePayment(idCompetition, token, email, user, nameCompetition, categoryWeight, categoryYear,  picture  )
