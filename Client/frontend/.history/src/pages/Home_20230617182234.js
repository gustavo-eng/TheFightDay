...
import taskServicePayment from '../service/taskServicePayment';
...
const Home = () => {
    ...
    // payCompetition: async (idCompetition, token, email, name, nameCompetition, categoryWeight, categoryWeight, categoryYear, picture)
    const handlePayment = async (evt, idCompetition) => {
        evt.preventDefault()
        setCardPayment(false)
        taskServicePayment.payCompetition()
    }
    // handleInputs ============================
                ...
                <div key={comp._id} className="cardCompetition">
                    ...
                    {cardPayment ?
                        <>
                            ...
                            <button onClick={handlePayment(comp._id)}>Pagar</button>
