...
const Home = () => {
    ...
    const handlePayment = async (e, index) => {
        ...
        const { nameCompetition, categoryWeight, categoryYear } = cardData;
        ...
        setPicture(null); // Limpa o arquivo selecionado
    };
    ...
    const handleFileChange = (e, index) => {
        ...
        setCardsData(prevState => {
            const updatedCardsData = [...prevState];
            updatedCardsData[index].picture = file;
            return updatedCardsData;
        });
    };
...
const FileInputExample = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Realize alguma ação com o arquivo selecionado, como fazer upload para o servidor
    console.log("Arquivo selecionado:", selectedFile);
  };

  return (
    <div>
      <h1>Exemplo de File Input</h1>
