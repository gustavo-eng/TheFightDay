...
const Home = () => {
    ...
    const handlePayment = async (e, index) => {
        ...
        const response = await controllServicePayment.savePayment(
            ...
            setSelectedCompetitionId(response._id); // Define o _id da competição selecionada
    ...
    const handleDeletePayment = async (e, index) => {
                    ...
                    {cardsData[index].showForm && (
                        <>
                            ...
                            <form>
                                ...
                                <input
                                    type="text"
                                    placeholder="_id da competição"
                                    name="competitionId"
                                    value={selectedCompetitionId} // Define o _id como valor do input
                                    disabled
                                />
                            </form>
