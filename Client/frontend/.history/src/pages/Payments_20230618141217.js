...
const Payments = () => {
    ...
    const decodeBase64Image = (base64String) => {
        ...
        for (let i = 0; i < decodedImage.length; i++) {
          ...
          const blob = new Blob([uint8Array], { type: "blob:https" }); // Define o tipo de arquivo da imagem (neste caso, PNG)
                ...
                paymentsUser.map(pays => (
                    <div className="mainPayment">
                        <div key={pays._id} className="containerPayment">
                            ...
                            <img  src={decodeBase64Image(pays.comprovante)} alt="Imagem nao decodificada"/>                            <p>Base64 image = {pays.comprovante}</p>
