...
const Home = () => {
    ...
    const updateCompetition = async (e, idCompetition) => {
        ...
        console.log('Consoles para  updateCompetition -> ')
        console.log('newNome')
        console.log(newNome)
        console.log('newDataPagemento')
        console.log(newDataPagemento)
        console.log('newDataCompeticao')
        console.log(newDataCompeticao)
        console.log('newPrice')
        console.log(newPrice)
        try {
            const response = await  controllServiceCompetition.updateCompetition(idCompetition, token, newNome, newDataPagemento, newDataCompeticao, newPrice)
            console.log('COMPETICAO ATUALIZADA COM SUCESSO --> ')
            console.log(response.json())

        } catch (error) {
            console.log('Erro ao atualizar competicao. Erro --> ')
            console.log(error)
        }
