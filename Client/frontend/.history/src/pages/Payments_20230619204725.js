                        ...
                        <div className="containerPayment">
                            ...
                            {openModalId === pays._id && (
                                ...
                                >
                                    ...
                                    />
                                    <hr />
                                    <button className="btn-close-modal-payment" onClick={closeModal}> Close </button>
                                    <button onClick={(e) => handleUpdatePayment(e, pays._id)}> Atualizar </button>
                                    { userPermission == 'sensei' ?
                                        <button className="btn-del-payment" onClick={(e) => handleDeletePayment(e, pays._id)}>  Deletar  </button>
                                        :null
                                    }
                                </ReactModal>
                            )}
