        ...
        <>
             <div className="container_contato">
                ...
                <form id="contact-form"  >
                    ...
                    <button onClick={handleDeleteUser} className="submit-btn pay ">Deletar usuário</button>
                    <button onClick={() => navigate('/payments')} className="submit-btn del ">Meus pagamentos</button>
                </form>
