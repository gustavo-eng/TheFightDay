...
const Payments = () => {
    ...
    const decodeBase64Image = (base64) => {
        const imageType = base64.substring("data:".length, base64.indexOf(";base64"));
        const decodedImage = atob(base64.split(",")[1]);
        ...
        return URL.createObjectURL(new Blob([buffer], { type: imageType }));
    };
