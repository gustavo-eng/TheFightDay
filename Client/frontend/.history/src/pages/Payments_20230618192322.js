...
const Payments = () => {
    ...
    const handleUpdatePayment = (e, idPayment) => {
        e.preventDefault()
        const response = controllServicePayment.updatePayment(token, userId,)
                        ...
                        <div key={pays._id} className="containerPayment">
                            ...
                            {openModalId === pays._id && (
                                ...
                                >
                                    ...
                                    <button onClick={() => handleUpdatePayment(e, )}> Atualizar </button>
                                    <button onClick={closeModal}> Deletar </button>
                                </ReactModal>
                            )}

                            <button onClick={() => openModal(pays, pays._id)}> Edit </button>
                        </div>
                    </div>
                ))
                : <>SERAA</>
