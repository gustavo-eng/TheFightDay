...
const Payments = () => {
    ...
    // deletePaymentByUser: async (token, userId) => {
    const handleDeletePayment = async (e) => {
        // idUser pegar no localStorage
        e.preventDefault()
        const response = await controllServicePayment.deletePaymentByUser(token, userId)
                            ...
                            {openModalId === pays._id && (
                                ...
                                >
                                    ...
                                    { userPermission == 'sensei' ?
                                        <button onClick={(e) => handleDeletePayment(e)}>  Deletar  </button>
                                        :null
                                    }
                                </ReactModal>
                            )}
